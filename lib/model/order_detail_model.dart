...
class OrderInfoModel extends Object {
  ...
  //构造方法
  OrderInfoModel(this.consignee, this.address, this.addTime, this.orderSn, this.actualPrice, this.mobile,
      this.orderStatusText, this.goodsPrice, this.id, this.freightPrice, this.handleOption);
