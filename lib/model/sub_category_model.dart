...
class SubCategoryListModel {
  ...
  factory SubCategoryListModel.fromJson(List<dynamic> parseJson) {
    ...
    productModels = parseJson.map((i) => SubCategoryModel.fromJson(i)).toList();
...
class SubCategoryModel extends Object {
  ...
  factory SubCategoryModel.fromJson(Map<String, dynamic> srcJson) => _$SubCategoryModelFromJson(srcJson);
