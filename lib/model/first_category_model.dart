...
class FirstListCategoryModel {
  ...
  factory FirstListCategoryModel.fromJson(List<dynamic> parseJson) {
    ...
    firstLevelCategorys = parseJson.map((i) => FirstCategoryModel.fromJson(i)).toList();
...
class FirstCategoryModel extends Object {
  ...
  factory FirstCategoryModel.fromJson(Map<String, dynamic> srcJson) => _$FirstCategoryModelFromJson(srcJson);
