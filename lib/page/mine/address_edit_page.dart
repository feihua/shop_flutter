...
import 'package:shop_flutter/model/address_model.dart';
import 'package:shop_flutter/service/address_service.dart';
          ...
          children: <Widget>[
            ...
            TextField(
                ...
                decoration: InputDecoration(
                    ...
                    hintStyle: TextStyle(color: Colors.grey, fontSize: ScreenUtil().setSp(26.0)),
                ...
                child: Container(
                  ...
                  child: Text(
                    ...
                    style: _cityText == null
                        ? TextStyle(color: Colors.grey, fontSize: ScreenUtil().setSp(26.0))
                        : TextStyle(color: Colors.black54, fontSize: ScreenUtil().setSp(26.0)),
                  ),
                )),
            Divider(
              color: Colors.grey[350],
              ...
              child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(color: KColor.defaultButtonColor, fontSize: ScreenUtil().setSp(26.0)),
                    ),
                  )),
            ),
            //当地址Id为0时不显示删除地址按钮
  ...
  show(context) async {
    ...
    Result? temp = await CityPickers.showCityPicker(
      ...
      itemBuilder: (item, list, index) {
        return Center(
          child: Text(item, maxLines: 1, style: TextStyle(fontSize: ScreenUtil().setSp(26.0))),
        );
      },
    ...
    showDialog<void>(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            title: Text(
              KString.TIPS,
              style: TextStyle(fontSize: ScreenUtil().setSp(30.0), color: Colors.black54),
            ),
            //删除收货地址提示文本
            content: Text(
              KString.ADDRESS_DELETE,
