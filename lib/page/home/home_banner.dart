...
class HomeBannerWidget extends StatelessWidget {
  ...
  HomeBannerWidget(this.bannerData, this.viewHeight);
    ...
    return Container(
      ...
      child: bannerData == null || bannerData?.length == 0
          ...
          ? Container(
              ...
              //没有数据文本提示
              child: const Text(KString.NO_DATA_TEXT),
            )
          //轮播组件
          : Swiper(
              //点击跳转
        onTap: (index) {
              ...
              itemBuilder: (BuildContext buildContext, int index) {
                //使用缓存图片组件显示轮播图
                return CachedImageWidget(double.infinity, double.infinity, bannerData![index]?.url ?? "");
              },
              //滚动时长
              duration: 10000,
              //指定分页组件
